        ...
        <div className="grid grid-cols-12 md:px-16 pt-14 pb-10 bg-white text-gray-800">
            <div className='col-span-12 lg:col-span-9 border-none lg:border-r-[1.3px] pr-0 md:pr-4 border-text-secondary-gray'>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <Image src={"/thumbs-down.svg"} alt={"Thumbs Down"} width={60} height={60}/>
                    </div>
                </div>
            ...
            <div className='col-span-12 lg:col-span-3 pt-10 lg:pt-0 space-y-14 px-10'>
                ...
                <div className="flex flex-col items-center space-y-2 text-center">
                   <Image src={"/phone.svg"} alt='Phone' width={60} height={60}/>
                ...
                {/* Chat Section */}
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={"/message.svg"} alt='Phone' width={60} height={60}/>
                    <p>24 hours a day</p>
                    <p>7 days a week</p>
                </div>
                ...
                {/* Email Section */}
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={"/email.svg"} alt='Phone' width={60} height={60}/>
                ...
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={"/location.svg"} alt='Phone' width={60} height={60}/>
